...
let NOTIF_RATINGSELECTED = NSNotification.Name.init(rawValue: "superlativeSelected")
let NOTIF_LAUNCHRATING = NSNotification.Name.init(rawValue: "launchSuperlative")
